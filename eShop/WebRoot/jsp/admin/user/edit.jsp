...
<body>
	<form:form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/updateUser" method="post" modelAttribute="user"></form:form>
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><form:input type="text"
						...
						<tr>
				<td style="float:left" class="ta_01" style="WIDTH: 100%" align="center"
					bgColor="#f5fafe" colSpan="4">
				会员<select name="vipFlag1" >
					<option <c:if test="${user.vipFlag==true }" selected="selected"" </c:if> value="y">>是</option>
					<option <c:if test="${user.vipFlag==false }"selected="selected" </c:if> value="n">>否</option>
				</select>
