...
<body>
	...
	<form id="userAction_save_do" name="Form1"
		...
		&nbsp;
		<table cellSpacing="1" cellPadding="5" width="100%" text-align="center"
			...
			<tr>
				<td width="18%" text-align="center" bgColor="#f5fafe" class="ta_01">
					市场价格：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="org_price" value="" id="userAction_save_do_logonName"
					class="bg" /></td>
				<td width="18%" text-align="center" bgColor="#f5fafe" class="ta_01">
					商城价格：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="cur_price" value="" id="userAction_save_do_logonName"
					class="bg" /></td>
			</tr>
			<tr>
				<td width="18%" text-align="center" bgColor="#f5fafe" class="ta_01">
