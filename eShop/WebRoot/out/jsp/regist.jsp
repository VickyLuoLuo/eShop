...
<head>
    ...
    <script>
        function checkForm() {
            ...
            if(vipFlag=="true"){
            	var flag=confirm("开通会员需要收费十元，您是否开通？");
            	if(!flag){
            		return false;
            	}
            }
    ...
    <div class="span5">
        <div class="logo">
            <a href="http://localhost:8080/mango/"> <img
                    src="${pageContexRt.request.contextPath}/image/r___________renleipic_01/index_2.jpg"
                    alt="超值换超值换购物商城"/></a>
        </div>
    </div>
    <div class="span9">
            ...
            <div class="main clearfix">
                ...
                <form:form commandName="user"
                    ...
                    <table>
                        ...
                        <tr>
                        			<th><span class="requiredField">*</span>身份选择:</th>
									<td><select id="vipFlag" name="vipFlag">
