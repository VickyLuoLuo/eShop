...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES ('5', '35', 'products/1/cs10026.jpeg', '1', '0', '100', '2017-06-25 21:00:00', null, '连衣裙', '3', 'Zs', '1');
...
ALTER TABLE `orderitem`
  ...
  ADD CONSTRAINT `FK_Refrences` FOREIGN KEY (`oid`) REFERENCES `orders` (`oid`);
