...
public class UserController{
	...
	public String register(@ModelAttribute @Valid User user,BindingResult result,HttpServletRequest request,HttpSession session,
		...
		String vipFlag = request.getParameter("vipFlag");
/*		if(vipFlag.equals("y")){
