				...
				<tbody>
					...
					<c:forEach var="orderItem" items="${order.orderItems}">
						<tr>
							...
							<td><fmt:formatNumber type="number" minFractionDigits="1" value="${orderItem.product.cur_price*orderItem.product.categorySecond.category.discount }" maxFractionDigits="1"/></td>
