		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/updateProduct" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">					
						<select name="is_hot">
							<option value="1" <c:if test="${product.is_hot ==1} selected" />>是</option>
							<option value="0" <c:if test="${product.is_hot ==0} selected" />>否</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="org_price" value="<c:out value="${product.org_price }"/>" id="userAction_save_do_logonName" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						二手价：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="cur_price" value="<c:out value="${product.cur_price }"/>" id="userAction_save_do_logonName" class="bg"/>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
