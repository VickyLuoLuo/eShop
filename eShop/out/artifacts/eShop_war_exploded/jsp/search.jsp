    ...
    <div class="span24">
    	<div id="hotProduct" class="hotProduct clearfix">
            ...
            <form action="${ pageContext.request.contextPath }/findByKey/cc" method="post">
                <span>商品名称</span> <input type="text" name="key"/><input type="submit" />
            </form>
            <form action="${ pageContext.request.contextPath }/findByPrice/min/max" method="post">
                <span>商品价格</span> <input type="text" name="min"/> <input type="text" name="max"/><input type="submit" />
            </form>
            <%--<form action="${ pageContext.request.contextPath }/findByKey/cc" method="post">--%>
                <%--<span>商品类别</span> <input type="text" name="key"/><input type="submit" />--%>
            <%--</form>--%>
            </div>
