...
<div style="position: absolute;right: 100px;left: 100px;">
	...
	<form id="Form1" name="Form1"
		...
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3"><strong>我的商品商品列表</strong>
					</TD>
				</tr>
				<tr>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach var="p" items="${products}" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%"><c:out value="${p.cur_price}" /></td>
									...
									<td align="center" style="HEIGHT: 22px"><a id="top"
										href="${ pageContext.request.contextPath }/topVipProduct/<c:out value="${p.pid}"/>">
											<img src="${pageContext.request.contextPath}/images/i_top.png"
											width="16" style="CURSOR: hand">
									</a></td>
								</tr>
							</c:forEach>
						</table>
