...
<div style="position: absolute;right: 100px;left: 100px;">
	...
	<form id="Form1" name="Form1"
		...
		action="${pageContext.request.contextPath}/exchangeOrder/${m.buyerProductId}/${m.buyerProductPrice}"
		method="post">
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach var="m" items="${message}" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%"> <a href="${pageContext.request.contextPath }/findByPid/<c:out value="${m.buyerProductId}"/>">
									...
									<td align="center" style="HEIGHT: 22px"><a id="message"
										href="${pageContext.request.contextPath}/exchangeOrder/${m.buyerProductId}/${m.buyerProductPrice}/${m.sellerProductId}">
											<img
