...
public class ArticleController {
	...
	@RequestMapping("/getArticleList/{type}")
	public String getArticleList(@PathVariable("type") String type, HttpSession session,HttpServletRequest request){
		List<Article> a = articleService.getArticleList(type);
